// admin-frontend/src/components/Reports.tsx
'use client';
...
const Reports: React.FC = () => {
  ...
  const { data: courseReportsData, loading: courseReportsLoading } = useQuery(GET_COURSE_APPLICATION_REPORTS);
  const { data: multipleCoursesData, loading: multipleCoursesLoading } = useQuery(GET_CANDIDATES_WITH_MULTIPLE_COURSES);
  const { data: unselectedData, loading: unselectedLoading } = useQuery(GET_UNSELECTED_CANDIDATES);
